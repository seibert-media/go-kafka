...
func (fake *PersistentConsumer) Consume(arg1 context.Context) error {
...
func (fake *PersistentConsumer) ConsumeCallCount() int {
	fake.consumeMutex.RLock()
	defer fake.consumeMutex.RUnlock()
	return len(fake.consumeArgsForCall)
}

func (fake *PersistentConsumer) ConsumeCalls(stub func(context.Context) error) {
	fake.consumeMutex.Lock()
	defer fake.consumeMutex.Unlock()
	fake.ConsumeStub = stub
}

func (fake *PersistentConsumer) ConsumeArgsForCall(i int) context.Context {
	fake.consumeMutex.RLock()
	defer fake.consumeMutex.RUnlock()
...
func (fake *PersistentConsumer) ConsumeReturns(result1 error) {
	fake.consumeMutex.Lock()
	defer fake.consumeMutex.Unlock()
...
func (fake *PersistentConsumer) ConsumeReturnsOnCall(i int, result1 error) {
	fake.consumeMutex.Lock()
	defer fake.consumeMutex.Unlock()
	fake.ConsumeStub = nil
...
func (fake *PersistentConsumer) Invocations() map[string][][]interface{} {
...
func (fake *PersistentConsumer) recordInvocation(key string, args []interface{}) {
...
var _ persistent.Consumer = new(PersistentConsumer)
